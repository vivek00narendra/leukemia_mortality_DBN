...
class NumPyAbstractSupervisedDBN(AbstractSupervisedDBN):
    ...
    def _fine_tuning(self, data, _labels):
        ...
        print('----')
        print(self.unsupervised_dbn.rbm_layers)
        print('----')
        ...
        for rbm in self.unsupervised_dbn.rbm_layers:
            ...
            with open('allaffy_dbn_no_repeat.txt', 'w') as f1:
                f1.write(str(np.shape(rbm.W)))
                f1.write('\n')
                for i in rbm.W:
                    f1.write(str(i))
                    f1.write('\n')
        ...
        for rbm in self.unsupervised_dbn.rbm_layers:
            print(self.unsupervised_dbn.rbm_layers)
            print(np.shape(self.unsupervised_dbn.rbm_layers))
            ...
            print(rbm.W)
            print(np.shape(rbm.W))
            print(rbm.c)
            print(np.shape(rbm.c))
